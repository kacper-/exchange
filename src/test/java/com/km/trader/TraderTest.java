...
public class TraderTest {
    ...
    public void testBookWithMD5() throws IOException, NoSuchAlgorithmException {
        Trader trader = new Trader(loadFromFile("onlyBook.txt"));
        String s = trader.trade();
    ...
    public void testTradeAndBookWithMD5() throws IOException, NoSuchAlgorithmException {
        Trader trader = new Trader(loadFromFile("tradeAndBook.txt"));
        String s = trader.trade();
    ...
    public void testOnlySell() throws IOException {
        Trader trader = new Trader(loadFromFile("onlySell.txt"));
        String s = trader.trade();
    ...
    public void testOnlyBuy() throws IOException {
        Trader trader = new Trader(loadFromFile("onlyBuy.txt"));
        String s = trader.trade();
    ...
    public void testAllSettled() throws IOException {
        Trader trader = new Trader(loadFromFile("allSettled.txt"));
        String s = trader.trade();
    ...
    public void testNullValueWithMD5() throws IOException, NoSuchAlgorithmException {
        Trader trader = new Trader(loadFromFile("columnErrors.txt"));
        String s = trader.trade();
